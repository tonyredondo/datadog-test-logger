...
using ConfigurationKeys = Vendor.Datadog.Trace.Configuration.ConfigurationKeys;
using MetricsTransportType = Vendor.Datadog.Trace.Vendors.StatsdClient.Transport.TransportType;
...
namespace Vendor.Datadog.Trace
{
    internal class TracerManagerFactory
    {
            ...
            ISpanSampler spanSampler)
        {
            ...
            telemetry.RecordIastSettings(Vendor.Datadog.Trace.Iast.Iast.Instance.Settings);
