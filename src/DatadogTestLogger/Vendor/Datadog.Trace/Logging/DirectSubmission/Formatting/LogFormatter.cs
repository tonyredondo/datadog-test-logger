...
namespace Vendor.Datadog.Trace.Logging.DirectSubmission.Formatting
{
    internal class LogFormatter
    {
        ...
        /// <summary>
        /// Format the log, based on <see cref="Vendor.Datadog.Trace.Vendors.Serilog.Formatting.Json.JsonFormatter"/>
