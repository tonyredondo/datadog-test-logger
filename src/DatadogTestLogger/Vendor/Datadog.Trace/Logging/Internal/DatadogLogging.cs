...
using Vendor.Datadog.Trace.Vendors.Serilog;
using Vendor.Datadog.Trace.Vendors.Serilog.Core;
using Vendor.Datadog.Trace.Vendors.Serilog.Core.Pipeline;
using Vendor.Datadog.Trace.Vendors.Serilog.Events;
using Vendor.Datadog.Trace.Vendors.Serilog.Sinks.File;

namespace Vendor.Datadog.Trace.Logging
{
