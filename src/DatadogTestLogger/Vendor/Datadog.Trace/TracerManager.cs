...
using Vendor.Datadog.Trace.DogStatsd;
...
using Vendor.Datadog.Trace.Util.Http.QueryStringObfuscation;
...
#pragma warning restore 618
                    ...
                    writer.WriteValue(Vendor.Datadog.Trace.Iast.Iast.Instance.Settings.Enabled);

                    writer.WritePropertyName("iast_deduplication_enabled");
                    writer.WriteValue(Vendor.Datadog.Trace.Iast.Iast.Instance.Settings.DeduplicationEnabled);

                    writer.WritePropertyName("iast_weak_hash_algorithms");
                    writer.WriteValue(Vendor.Datadog.Trace.Iast.Iast.Instance.Settings.WeakHashAlgorithms);

                    writer.WritePropertyName("iast_weak_cipher_algorithms");
                    writer.WriteValue(Vendor.Datadog.Trace.Iast.Iast.Instance.Settings.WeakCipherAlgorithms);
