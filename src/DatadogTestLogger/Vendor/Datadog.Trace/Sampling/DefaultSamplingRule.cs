...
namespace Vendor.Datadog.Trace.Sampling
{
    internal class DefaultSamplingRule : ISamplingRule
    {
        ...
        public int SamplingMechanism => _sampleRates.Count == 0 && _defaultSamplingRate == null ?
                                            Vendor.Datadog.Trace.Sampling.SamplingMechanism.Default :
                                            Vendor.Datadog.Trace.Sampling.SamplingMechanism.AgentRate;
