...
using System;
using Vendor.Datadog.Trace.Ci.Agent.Payloads;
using Vendor.Datadog.Trace.Ci.Coverage.Models;
using Vendor.Datadog.Trace.Ci.EventModel;
using Vendor.Datadog.Trace.Vendors.MessagePack;
using Vendor.Datadog.Trace.Vendors.MessagePack.Formatters;
using Vendor.Datadog.Trace.Vendors.MessagePack.Resolvers;

namespace Vendor.Datadog.Trace.Ci.Agent.MessagePack
{
