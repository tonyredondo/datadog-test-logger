...
using Vendor.Datadog.Trace.HttpOverStreams.HttpContent;
using Vendor.Datadog.Trace.Logging;
using Vendor.Datadog.Trace.Util;
using StreamContent = Vendor.Datadog.Trace.HttpOverStreams.HttpContent.StreamContent;

namespace Vendor.Datadog.Trace.HttpOverStreams
{
