...
namespace Vendor.Datadog.Trace.Iast;

internal static class StackWalker
{
    public static readonly string[] ExcludeSpanGenerationTypes = { "Vendor.Datadog.Trace.Debugger.Helpers.StringExtensions" };
    public static readonly string[] AssemblyNamesToSkip = { "Vendor.Datadog.Trace", "System.Security.Cryptography.Primitives", "System.Security.Cryptography.Algorithms", "System.Security.Cryptography.Csp" };
