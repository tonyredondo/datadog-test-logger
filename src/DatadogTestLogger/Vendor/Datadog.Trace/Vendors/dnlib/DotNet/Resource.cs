...
namespace Vendor.Datadog.Trace.Vendors.dnlib.DotNet {
	...
	/// Resource base class
	/// </summary>
	internal abstract class Resource : IMDTokenProvider, IHasCustomAttribute, IHasCustomDebugInformation {
	...
	/// </summary>
	internal class EmbeddedResource : Resource {
	...
	/// </summary>
	internal class AssemblyLinkedResource : Resource {
		AssemblyRef asmRef;
	...
	/// </summary>
	internal class LinkedResource : Resource {
		FileDef file;
