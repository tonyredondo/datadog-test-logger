...
namespace Vendor.Datadog.Trace.Vendors.dnlib.DotNet.Emit {
	/// <summary>
	/// Reads strings from #US heap
	/// </summary>
	internal interface IStringResolver {
		/// <summary>
	...
	/// </summary>
	internal interface IInstructionOperandResolver : ITokenResolver, IStringResolver {
	}
	...
	/// </summary>
	internal sealed class MethodBodyReader : MethodBodyReaderBase {
