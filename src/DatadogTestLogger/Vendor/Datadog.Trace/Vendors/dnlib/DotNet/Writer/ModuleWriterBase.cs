...
using Vendor.Datadog.Trace.Vendors.dnlib.DotNet.Pdb.WindowsPdb;
using System.Text;
...
namespace Vendor.Datadog.Trace.Vendors.dnlib.DotNet.Writer {
	...
	/// </summary>
	internal readonly struct ModuleWriterEventArgs {
		/// <summary>
	...
	/// </summary>
	internal readonly struct ModuleWriterProgressEventArgs {
		/// <summary>
		/// Gets the writer (<see cref="ModuleWriter"/> or <see cref="NativeModuleWriter"/>)
		/// </summary>
		public ModuleWriterBase Writer { get; }
	...
	/// Content ID
	/// </summary>
	internal readonly struct ContentId {
		/// <summary>
		/// Gets the GUID
		/// </summary>
	...
	internal delegate void EventHandler2<TEventArgs>(object sender, TEventArgs e);

	/// <summary>
	/// PDB writer options
	/// </summary>
	[Flags]
	internal enum PdbWriterOptions {
		/// <summary>
		/// No bit is set
		/// </summary>
		None						= 0,
	...
	/// </summary>
	internal class ModuleWriterOptionsBase {
	...
	/// </summary>
	internal abstract class ModuleWriterBase : ILogger {
