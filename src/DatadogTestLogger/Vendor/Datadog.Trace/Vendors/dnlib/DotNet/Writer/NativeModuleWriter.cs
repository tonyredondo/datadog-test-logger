...
namespace Vendor.Datadog.Trace.Vendors.dnlib.DotNet.Writer {
	...
	/// </summary>
	internal sealed class NativeModuleWriterOptions : ModuleWriterOptionsBase {
		/// <summary>
	...
	/// </summary>
	internal sealed class NativeModuleWriter : ModuleWriterBase {
		...
		/// Original PE section
		/// </summary>
		internal sealed class OrigSection : IDisposable {
