...
using Vendor.Datadog.Trace.Vendors.dnlib.Utils;
using Vendor.Datadog.Trace.Vendors.dnlib.DotNet.MD;
using Vendor.Datadog.Trace.Vendors.dnlib.DotNet.Pdb;
using Vendor.Datadog.Trace.Vendors.dnlib.DotNet.Writer;
using Vendor.Datadog.Trace.Vendors.dnlib.PE;
using Vendor.Datadog.Trace.Vendors.dnlib.Threading;
using Vendor.Datadog.Trace.Vendors.dnlib.W32Resources;
...
namespace Vendor.Datadog.Trace.Vendors.dnlib.DotNet {
	...
	/// </summary>
	internal abstract class ModuleDef : IHasCustomAttribute, IHasCustomDebugInformation, IResolutionScope, IDisposable, IListListener<TypeDef>, IModule, ITypeDefFinder, IDnlibDef, ITokenResolver, ISignatureReaderHelper {
	...
	/// </summary>
	internal class ModuleDefUser : ModuleDef {
		/// <summary>
		/// Default constructor
		/// </summary>
	...
	/// </summary>
	internal class ModuleDefMD2 : ModuleDef, IMDTokenProviderMD {
