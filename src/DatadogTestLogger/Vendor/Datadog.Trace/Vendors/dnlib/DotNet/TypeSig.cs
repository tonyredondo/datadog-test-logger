...
namespace Vendor.Datadog.Trace.Vendors.dnlib.DotNet {
	...
	/// Type sig base class
	/// </summary>
	internal abstract class TypeSig : IType {
		uint rid;
	...
	/// </summary>
	internal abstract class LeafSig : TypeSig {
		/// <inheritdoc/>
	...
	/// </summary>
	internal abstract class TypeDefOrRefSig : LeafSig {
	...
	/// A core library type
	/// </summary>
	internal sealed class CorLibTypeSig : TypeDefOrRefSig {
	...
	/// </summary>
	internal abstract class ClassOrValueTypeSig : TypeDefOrRefSig {
		/// <summary>
		/// Constructor
		/// </summary>
	...
	/// </summary>
	internal sealed class ValueTypeSig : ClassOrValueTypeSig {
		/// <inheritdoc/>
	...
	/// </summary>
	internal sealed class ClassSig : ClassOrValueTypeSig {
		/// <inheritdoc/>
	...
	/// </summary>
	internal abstract class GenericSig : LeafSig {
	...
	/// </summary>
	internal sealed class GenericVar : GenericSig {
		/// <inheritdoc/>
	...
	/// </summary>
	internal sealed class GenericMVar : GenericSig {
		/// <inheritdoc/>
	...
	/// </summary>
	internal sealed class SentinelSig : LeafSig {
		/// <inheritdoc/>
	...
	/// </summary>
	internal sealed class FnPtrSig : LeafSig {
	...
	/// </summary>
	internal sealed class GenericInstSig : LeafSig {
	...
	/// </summary>
	internal abstract class NonLeafSig : TypeSig {
	...
	/// </summary>
	internal sealed class PtrSig : NonLeafSig {
		/// <inheritdoc/>
	...
	/// </summary>
	internal sealed class ByRefSig : NonLeafSig {
		/// <inheritdoc/>
	...
	/// Array base class
	/// </summary>
	internal abstract class ArraySigBase : NonLeafSig {
		/// <summary>
		/// Constructor
		/// </summary>
	...
	internal sealed class ArraySig : ArraySigBase {
		uint rank;
	...
	internal sealed class SZArraySig : ArraySigBase {
		/// <inheritdoc/>
	...
	/// </summary>
	internal abstract class ModifierSig : NonLeafSig {
	...
	/// </summary>
	internal sealed class CModReqdSig : ModifierSig {
		/// <inheritdoc/>
	...
	/// </summary>
	internal sealed class CModOptSig : ModifierSig {
		/// <inheritdoc/>
	...
	/// </summary>
	internal sealed class PinnedSig : NonLeafSig {
		/// <inheritdoc/>
	...
	/// </summary>
	internal sealed class ValueArraySig : NonLeafSig {
		uint size;
	...
	/// </summary>
	internal sealed class ModuleSig : NonLeafSig {
		uint index;
