...
namespace Vendor.Datadog.Trace.Vendors.dnlib.DotNet {
	...
	/// </summary>
	internal abstract class PropertyDef : IHasConstant, IHasCustomAttribute, IHasSemantic, IHasCustomDebugInformation, IFullName, IMemberDef {
		/// <summary>
	...
	/// </summary>
	internal class PropertyDefUser : PropertyDef {
		/// <summary>
		/// Default constructor
		/// </summary>
