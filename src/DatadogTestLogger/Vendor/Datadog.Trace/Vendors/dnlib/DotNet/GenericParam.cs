...
namespace Vendor.Datadog.Trace.Vendors.dnlib.DotNet {
	...
	internal abstract class GenericParam : IHasCustomAttribute, IHasCustomDebugInformation, IMemberDef, IListListener<GenericParamConstraint> {
		/// <summary>
	...
	/// </summary>
	internal class GenericParamUser : GenericParam {
		/// <summary>
		/// Default constructor
		/// </summary>
