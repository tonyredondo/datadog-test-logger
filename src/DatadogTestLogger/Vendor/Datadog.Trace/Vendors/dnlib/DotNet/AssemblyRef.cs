...
namespace Vendor.Datadog.Trace.Vendors.dnlib.DotNet {
	...
	/// </summary>
	internal abstract class AssemblyRef : IHasCustomAttribute, IImplementation, IResolutionScope, IHasCustomDebugInformation, IAssembly, IScope {
		/// <summary>
	...
	/// </summary>
	internal class AssemblyRefUser : AssemblyRef {
		/// <summary>
