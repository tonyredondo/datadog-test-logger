...
namespace Vendor.Datadog.Trace.Vendors.dnlib.DotNet {
	...
	/// </summary>
	internal abstract class ModuleRef : IHasCustomAttribute, IMemberRefParent, IHasCustomDebugInformation, IResolutionScope, IModule, IOwnerModule {
		/// <summary>
	...
	/// </summary>
	internal class ModuleRefUser : ModuleRef {
		/// <summary>
		/// Constructor
		/// </summary>
