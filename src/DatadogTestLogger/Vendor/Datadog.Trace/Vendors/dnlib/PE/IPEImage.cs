...
namespace Vendor.Datadog.Trace.Vendors.dnlib.PE {
	/// <summary>
	/// Converts <see cref="RVA"/>s to/from <see cref="FileOffset"/>s
	/// </summary>
	internal interface IRvaFileOffsetConverter {
		/// <summary>
	...
	/// </summary>
	internal interface IPEImage : IRvaFileOffsetConverter, IDisposable {
		/// <summary>
	...
	/// Interface to access a PE image
	/// </summary>
	internal interface IInternalPEImage : IPEImage {
		/// <summary>
