...
namespace Vendor.Datadog.Trace.AspNet
{
    internal static class SharedItems
    {
        public const string HttpContextPropagatedResourceNameKey = "__Vendor.Datadog.Trace.ClrProfiler.Managed.AspNetMvcIntegration-aspnet.resourcename";
