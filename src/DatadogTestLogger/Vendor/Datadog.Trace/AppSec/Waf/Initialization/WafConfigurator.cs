...
using Vendor.Datadog.Trace.AppSec.Waf.NativeBindings;
using Vendor.Datadog.Trace.AppSec.Waf.ReturnTypesManaged;
...
using Vendor.Datadog.Trace.Vendors.Newtonsoft.Json.Linq;
using Vendor.Datadog.Trace.Vendors.Serilog.Events;

namespace Vendor.Datadog.Trace.AppSec.Waf.Initialization
{
    internal static class WafConfigurator
    {
        ...
        private static Stream GetRulesManifestStream()
        {
            ...
            return assembly.GetManifestResourceStream("Vendor.Datadog.Trace.AppSec.Waf.rule-set.json");
        }
