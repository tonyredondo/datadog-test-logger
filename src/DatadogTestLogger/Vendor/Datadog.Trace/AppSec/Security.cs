...
using Vendor.Datadog.Trace.AppSec.RcmModels.AsmData;
using Vendor.Datadog.Trace.AppSec.Transports;
using Vendor.Datadog.Trace.AppSec.Transports.Http;
using Vendor.Datadog.Trace.AppSec.Waf;
using Vendor.Datadog.Trace.AppSec.Waf.ReturnTypes.Managed;
...
namespace Vendor.Datadog.Trace.AppSec
{
    /// <summary>
