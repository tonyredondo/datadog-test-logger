...
using Vendor.Datadog.Trace.ClrProfiler.AutoInstrumentation.Logging.NLog.DirectSubmission.Proxies;
using Vendor.Datadog.Trace.ClrProfiler.AutoInstrumentation.Logging.NLog.DirectSubmission.Proxies.Pre43;
using Vendor.Datadog.Trace.DuckTyping;
using Vendor.Datadog.Trace.Logging;
using Vendor.Datadog.Trace.Util;

namespace Vendor.Datadog.Trace.ClrProfiler.AutoInstrumentation.Logging.NLog.DirectSubmission
{
