...
using System.Text;
using Vendor.Datadog.Trace.ClrProfiler.AutoInstrumentation.Logging.Serilog.DirectSubmission.Formatting;
using Vendor.Datadog.Trace.Logging.DirectSubmission.Formatting;
using Vendor.Datadog.Trace.Logging.DirectSubmission.Sink;

namespace Vendor.Datadog.Trace.ClrProfiler.AutoInstrumentation.Logging.Serilog.DirectSubmission
{
