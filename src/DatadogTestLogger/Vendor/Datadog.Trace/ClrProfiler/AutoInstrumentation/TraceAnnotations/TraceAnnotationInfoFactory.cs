...
namespace Vendor.Datadog.Trace.ClrProfiler.AutoInstrumentation.TraceAnnotations
{
    internal static class TraceAnnotationInfoFactory
    {
        private const string TraceAttributeFullName = "Vendor.Datadog.Trace.Annotations.TraceAttribute";
