...
using System;
using Vendor.Datadog.Trace.ClrProfiler.AutoInstrumentation.Http.HttpClient;
...
namespace Vendor.Datadog.Trace.ClrProfiler.AutoInstrumentation.Grpc.GrpcDotNet.GrpcNetClient
{
