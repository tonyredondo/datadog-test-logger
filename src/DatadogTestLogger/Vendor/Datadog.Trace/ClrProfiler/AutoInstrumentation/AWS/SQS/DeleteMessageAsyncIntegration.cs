...
namespace Vendor.Datadog.Trace.ClrProfiler.AutoInstrumentation.AWS.SQS
{
    ...
    public class DeleteMessageAsyncIntegration
    {
        ...
        internal static CallTargetState OnMethodBegin<TTarget, TDeleteMessageRequest>(TTarget instance, TDeleteMessageRequest request, CancellationToken cancellationToken)
