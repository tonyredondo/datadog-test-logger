...
namespace Vendor.Datadog.Trace.Debugger.PInvoke
{
    internal static class DebuggerNativeMethods
    {
        ...
        {
            [DllImport("Vendor.Datadog.Tracer.Native.dll")]
            ...
            [DllImport("Vendor.Datadog.Tracer.Native.dll", CharSet = CharSet.Unicode)]
        ...
        {
            [DllImport("Vendor.Datadog.Tracer.Native")]
            public static extern void InstrumentProbes(
                [In] NativeMethodProbeDefinition[] methodProbes,
                int methodProbesLength,
                [In] NativeLineProbeDefinition[] lineProbes,
