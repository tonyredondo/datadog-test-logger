...
namespace Vendor.Datadog.Trace.SourceGenerators.InstrumentationDefinitions;

internal static class Constants
{
    public const string InstrumentAttribute = "Vendor.Datadog.Trace.ClrProfiler.InstrumentMethodAttribute";
    public const string AdoNetInstrumentAttribute = "Vendor.Datadog.Trace.ClrProfiler.AutoInstrumentation.AdoNet.AdoNetClientInstrumentMethodsAttribute";
