...
namespace Datadog.Trace.Vendors.Datadog.Trace.Vendors.dnlib.DotNet {
	...
	/// </summary>
	internal sealed class RawMarshalType : MarshalType {
		byte[] data;
	...
	/// </summary>
	internal sealed class FixedSysStringMarshalType : MarshalType {
		int size;
	...
	/// </summary>
	internal sealed class SafeArrayMarshalType : MarshalType {
		VariantType vt;
	...
	/// </summary>
	internal sealed class FixedArrayMarshalType : MarshalType {
		int size;
	...
	/// </summary>
	internal sealed class ArrayMarshalType : MarshalType {
		NativeType elementType;
		int paramNum;
		int numElems;
		int flags;
	...
	/// </summary>
	internal sealed class CustomMarshalType : MarshalType {
		UTF8String guid;
	...
	/// </summary>
	internal sealed class InterfaceMarshalType : MarshalType {
		int iidParamIndex;
