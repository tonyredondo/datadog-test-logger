...
// <copyright file="StartRootSpanIntegration.cs" company="Datadog">
...
namespace DatadogTestLogger.Vendors.Datadog.Trace.ClrProfiler.AutoInstrumentation.OpenTelemetry
{
    /// <summary>
    ...
    internal class StartRootSpanIntegration
    {
