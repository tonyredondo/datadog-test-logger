...
// <copyright file="ExecuteAsyncIntegrationV5AndV7.cs" company="Datadog">
...
namespace DatadogTestLogger.Vendors.Datadog.Trace.ClrProfiler.AutoInstrumentation.GraphQL.Net
{
    ...
    internal class ExecuteAsyncIntegrationV5AndV7
    {
        /// <summary>
        ...
        internal static TExecutionResult OnAsyncMethodEnd<TTarget, TExecutionResult>(TTarget instance, TExecutionResult executionResult, Exception exception, in CallTargetState state)
        {
            ...
            try
            {
                ...
                else if (state.State is IExecutionContextV5AndV7 context)
                {
