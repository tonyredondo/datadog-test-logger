...
namespace DatadogTestLogger.Vendors.Datadog.Trace.ClrProfiler.AutoInstrumentation.Http.HttpClient.SocketsHttpHandler
{
    /// <summary>
    ...
    internal class SocketsHttpHandlerSyncIntegration
    {
