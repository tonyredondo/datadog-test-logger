...
using DatadogTestLogger.Vendors.Mono.Cecil.Metadata;
...
namespace DatadogTestLogger.Vendors.Mono.Cecil.Cil {
	...
	internal sealed class PortablePdbWriter : ISymbolWriter {
	...
	internal sealed class EmbeddedPortablePdbWriter : ISymbolWriter {
