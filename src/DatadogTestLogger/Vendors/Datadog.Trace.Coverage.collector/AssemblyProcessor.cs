...
using DatadogTestLogger.Vendors.Mono.Cecil;
using DatadogTestLogger.Vendors.Mono.Cecil.Cil;
using CallSite = DatadogTestLogger.Vendors.Mono.Cecil.CallSite;
using MethodAttributes = DatadogTestLogger.Vendors.Mono.Cecil.MethodAttributes;
using TypeAttributes = DatadogTestLogger.Vendors.Mono.Cecil.TypeAttributes;
