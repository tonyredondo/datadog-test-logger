...
using DatadogTestLogger.Vendors.Datadog.Trace.Ci.Coverage.Exceptions;
...
using Formatting = DatadogTestLogger.Vendors.Datadog.Trace.Vendors.Newtonsoft.Json.Formatting;
...
namespace DatadogTestLogger.Vendors.Datadog.Trace.Coverage.Collector
{
    ...
    internal class CoverageCollector : DataCollector
    {
